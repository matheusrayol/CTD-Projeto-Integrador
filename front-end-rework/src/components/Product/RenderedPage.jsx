...
export default function RenderedPage(product) {
    ...
    const [expandedImgSrc, setExpandedImgSrc] = useState(`${product.productData.images[0].urlImage}`);
                            ...
                            <div className="col d-flex justify-content-start">
                                <div className="d-grid d-xxl-flex align-items-xxl-center">
                                    <button className="btn btn-light btn-sm disabled fs-6 poppins disabled ms-3" type="button" style={{ fontWeight: `bold`, fontSize: 19 + `px`, opacity: `1` }} disabled>
                                        {product.productData.category.qualification}
                                    </button>
                                </div>
                        ...
                        <div className="row d-flex justify-content-center align-items-center">
                            <div className="col">
                                <span className="text-truncate d-flex align-items-center ubuntu fs-5 ms-3">
                                    ...
                                    {product.productData.city.name}, {product.productData.city.state} - {product.productData.city.country}
                                </span>
                            </div>
                            <div className="col d-flex justify-content-end align-items-center">
                        ...
                        <div className="row">
                            <div className="col-lg-12 col-xl-7 col-xxl-7 mb-3">
                                <div className="img-container">
                                    <img id="expandedImg" className="rounded" style={{ width: 100 + `%` }} src={expandedImgSrc} alt={imgText} />
                                </div>
                                <div className="row img-row" style={{ paddingRight: 10 + `px`, paddingLeft: 10 + `px` }}>
                                    <div className="col column">
                                        <img className="img-thumbnail img-fluid img-square" src={product.productData.images[0].urlImage} alt={product.productData.name} onClick={handleImgClick} />
                                    </div>
                                    <div className="col column">
                                        <img className="img-thumbnail img-fluid img-square" src={product.productData.images[1].urlImage} alt={product.productData.name} onClick={handleImgClick} />
                                    </div>
                                    <div className="col column">
                                        <img className="img-thumbnail img-fluid img-square" src={product.productData.images[2].urlImage} alt={product.productData.name} onClick={handleImgClick} />
                                    </div>
                                    <div className="col column">
                                        <img className="img-thumbnail img-fluid img-square" src={product.productData.images[3].urlImage} alt={product.productData.name} onClick={handleImgClick} />
                                    </div>
                                    <div className="col column">
                                        <img className="img-thumbnail img-fluid img-square" src={product.productData.images[4].urlImage} alt={product.productData.name} onClick={handleImgClick} />
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-12 col-xl-5 d-flex flex-column bg-white rounded shadow-lg px-4 py-4 position-relative">
                                ...
                                <div className="d-flex row pt-3">
                                    ...
                                    <div className="btn-group" role="group"><button className="btn btn-success poppins" type="button">Verificar disponibilidade</button></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container shadow rounded bg-white">
                        <div className="row row-cols-1 row-cols-lg-2 mt-3 bg-transparent">
                            <div className="col d-flex flex-column py-4 px-4 bg-transparent">
                                ...
                                <div className="text-center mt-3"><button className="btn btn-success poppins" type="button">Efetuar reserva</button></div>
                            </div>
